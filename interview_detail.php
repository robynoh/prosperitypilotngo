...
$recordperpage = 6;
	...
	$output="";
	$query= "SELECT * FROM `interviews`  where interview_id='".$_GET['id']."'";
	$result=$connection->retrieve($query);
	$rows=$connection->arrayFetch($result);
	
	$query2= "SELECT * FROM `interviews`  where interview_id !='".$_GET['id']."'";
...
<head>
    ...
    <title>Prosperity Pilot Initiative - <?php echo $connect->show_interview_title($_GET['id']);?></title>
                ...
                <div class="row">                    
                    <div class="col-lg-9 col-md-12">
						...
						<?php  foreach($rows as $row){?>
                            <div class="d-flex">
                                <div class="post-date txt-blue"><?php echo $row['date_posted']; ?></div>
                                <div class="mx-2">/</div>
                            ...
                            <div class="causes-wrap single">
                                <div class="img-wrap">
                                    <img src="<?php echo $connection->url(); ?>/mgt/interview_photos/<?php echo $row['filename']?>" alt="">
                                </div>
                                ...
                                <div class="widget-wrap">
                                    ...
                                    <div class="owl-carousel owl-theme" id="sidebar-causes">
                                        ...
                                        <div class="causes-wrap">
                                            <div class="img-wrap">
                                                <a href="causes-single.html">  <img src="<?php echo $connection->url(); ?>/mgt/interview_photos/<?php echo $row2['filename']?>" alt=""></a>
                                            ...
                                            <div class="content-wrap">
                                                ...
                                                <div class="text-md-right">
                                                   <a href="interview_detail?id=<?php echo $row2['interview_id']; ?>" class="read-more-line"><span>Read More</span></a>
                                                <!-- <a href="<?php //echo $connection->url(); ?>/project/<?php // echo str_replace(' ', '-',$row2['title']);?>/<?php // echo $row2['interview_id']; ?>" class="read-more-line"><span>Read More</span></a> --->
