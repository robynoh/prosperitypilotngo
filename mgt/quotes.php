...
$news =new news();
	...
	$result  =  ExecuteQuery("SELECT * FROM `quotes`");
                     ...
                     <div class="row-fluid"><?php echo $msg;?>
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left" style="font-weight:bold;color:#000;font-size:14px"> All Quotes</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                   <div class="table-toolbar">
                                      <div class="btn-group">
                                       ...
                                       <a href="add_quotes"  class="btn " >Add Quotes </a><i class="icon-plus icon-white"></i>
                                      </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
								...
								while($rows=SqlArray($result)){?>
                                 ...
                                 <tr class="gradeU">
                                               ...
                                               <?php echo strip_tags( substr( $rows['quote'],0,170)) ;?>...</td>
                                                <td><?php echo $rows['position'];?></td>
												
												 <td class="center"><div class="btn-group"><a class="btn btn-primary"  style="color:#fff" href="edit_quotes?news_id=<?php echo ucwords($rows['quote_id']);?>"><i class="icon-pencil icon-white"></i> Edit</a></div></td>
                                              
												
                                                <td class="center"><div class="btn-group"><a href="delete?quote_id=<?php echo $rows['quote_id'];?>" class="btn btn-danger" style="color:#fff"><i class="icon-remove icon-white"></i> Delete</a></button></div></td>
                                            </tr>
