...
if(isset($_GET['news_id'])){
	...
	$resultEdit=ExecuteQuery("select * from quotes  where quote_id='".$_GET['news_id']."'");
...
if(isset($_POST['update'])){
	...
	if(empty($Filename)){
		...
		ExecuteQuery("update quotes set name='".addslashes($_POST['name'])."',quote='".addslashes($_POST['quote'])."',content='".addslashes($_POST['content'])."',filename='".$rows_Edit['filename']."',position='".addslashes($_POST['position'])."' where quote_id='".$_GET['news_id']."'");
	...
	$date = date("Y-m-d");
	if(ExecuteQuery("update quotes set name='".addslashes($_POST['name'])."',quote='".addslashes($_POST['quote'])."',content='".addslashes($_POST['content'])."',filename='".$Filename."',position='".addslashes($_POST['position'])."' where quote_id='".$_GET['news_id']."'")){
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:14px; color:#000">Project Edit</b></div>
                            </div>
                            <div class="block-content collapse in">
                              <?php echo $message;?> <div class="span3" style="margin-left:22%; margin-bottom:10px">
                                      <a href="#" class="thumbnail">
                                        <img src="quote_photos/<?php echo $rows_Edit['filename'];?>" width="208" height="183">
                                      </a>
						...
						<fieldset>
  							...
  							<div class="control-group">
								...
								<div class="control-group">
  								...
  								<div class="controls">
  									<input type="text" name="quote" data-required="1" class="span6 m-wrap" value="<?php echo $rows_Edit['quote'];?>"/>
  								</div>
  							</div>
