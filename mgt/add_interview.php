...
if($size > 9000000){
	...
	$pass = "interview_photos/".$name.".$ext";
	move_uploaded_file($_FILES['fileField']['tmp_name'],$pass);
	$image = $name.".$ext";
	
	if(ExecuteQuery("insert into interviews (interview_id,name,content,date_posted,title,filename)
		values(NULL,'".addslashes($_POST['name'])."','".addslashes($_POST['content'])."','".date('d-m-Y')."','".addslashes($_POST['title'])."','".$image."')")){
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:14px; color:#000">Add Interview</b></div>
                            </div>
