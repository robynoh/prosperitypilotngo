...
if(isset($_GET['news_id'])){
	...
	$resultEdit=ExecuteQuery("select * from videos  where video_id='".$_GET['news_id']."'");
...
if(isset($_POST['update'])){
		...
		ExecuteQuery("update videos set title='".mysqli_real_escape_string($connection,$_POST['title'])."',description='".mysqli_real_escape_string($connection,$_POST['content'])."' where video_id='".$_GET['news_id']."'");
...
if(isset($_GET['confirmation'])&& $_GET['confirmation']="updated"){
	...
	$resultEdit=ExecuteQuery("select * from videos  where video_id='".$_GET['news_id']."'");
		...
		$rows_Edit = SqlArray($resultEdit);
		$message=successMsg('video updated succesfully');
	}
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:14px; color:#000">Video Edit</b></div>
                            </div>
                            <div class="block-content collapse in">
                              <?php echo $message;?> <div class="span3" style="margin-left:22%; margin-bottom:10px">
                                      <?php echo $rows_Edit['video_link'];?>
					...
					<form action="" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data" method="post">
						<fieldset>
                            ...
                            <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <textarea name="content" class="input-xlarge textarea"  placeholder="Enter item description ..." style="width: 600px; height: 200px"><?php echo $rows_Edit['description'];?></textarea>
                                          </div>
                                        </div>
