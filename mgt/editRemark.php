...
if(isset($_GET['news_id'])){
	...
	$resultEdit=ExecuteQuery("select * from remarks  where remark_id='".$_GET['news_id']."'");
...
if(isset($_POST['update'])){
	...
	//$date = date("Y-m-d");
	if(ExecuteQuery("update remarks set title='".addslashes($_POST['title'])."',remark='".addslashes($_POST['content'])."' ,time_of_event='".addslashes($_POST['time'])."' where remark_id='".$_GET['news_id']."'")){
...
if(isset($_GET['confirmation'])&& $_GET['confirmation']="updated"){
	...
	$resultEdit=ExecuteQuery("select * from remarks  where remark_id='".$_GET['news_id']."'");
		...
		$rows_Edit = SqlArray($resultEdit);
		$message=successMsg('Remark updated succesfully');
	}
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                              <?php echo $message;?><div class="span12">
					...
					<form action="" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data" method="post">
						<fieldset>
                            ...
                            <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <textarea name="content" class="input-xlarge textarea"  placeholder="Enter item description ..." style="width: 600px; height: 200px"><?php echo $rows_Edit['remark'];?></textarea>
                                          </div>
                                        </div>
  								...
  								<div class="controls">
  									<input type="text" name="time" data-required="1" value="<?php echo $rows_Edit['time_of_event'];?>" class="span6 m-wrap"/>
  								</div>
  							</div>
