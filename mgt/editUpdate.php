...
if(isset($_GET['news_id'])){
	...
	$resultEdit=ExecuteQuery("select * from palliatives  where update_id='".$_GET['news_id']."'");
...
if(isset($_POST['update'])){
	...
	if(empty($Filename)){
		...
		ExecuteQuery("update palliavtives set title='".addslashes($_POST['title'])."',content='".addslashes($_POST['content'])."',filename='".$rows_Edit['filename']."' where update_id='".$_GET['news_id']."'");
	...
	$date = date("Y-m-d");
	if(ExecuteQuery("update palliatives set title='".addslashes($_POST['title'])."',content='".addslashes($_POST['content'])."',filename='".$Filename."' where update_id='".$_GET['news_id']."'")){
                            ...
                            <div class="block-content collapse in">
                              <?php echo $message;?> <div class="span3" style="margin-left:22%; margin-bottom:10px">
                                      <a href="#" class="thumbnail">
                                        <img src="palliative_photos/<?php echo $rows_Edit['filename'];?>" width="208" height="183">
                                      </a>
