...
if($size > 9000000){
	...
	if(ExecuteQuery("insert into videos (video_id,title,img,description,video_link,post_time,day,month,year)
		
	values(NULL,'".mysqli_real_escape_string($connection,$_POST['title'])."','".$image."','".mysqli_real_escape_string($connection,$_POST['content'])."','".mysqli_real_escape_string($connection,$_POST['link'])."','".date('d F Y')."','".date('d')."','".date('F')."','".date('Y')."')")){
