...
if($size > 9000000){
	...
	$pass = "quote_photos/".$name.".$ext";
	move_uploaded_file($_FILES['fileField']['tmp_name'],$pass);
	$image = $name.".$ext";
	
	if(ExecuteQuery("insert into quotes (quote_id,name,quote,content,position,filename)
		values(NULL,'".addslashes($_POST['name'])."','".addslashes($_POST['quote'])."','".addslashes($_POST['content'])."','".addslashes($_POST['position'])."','".$image."')")){
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:14px; color:#000">Add Quotes</b></div>
                            </div>
					...
					<form action="" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data" method="post">
					  ...
					  <div class="control-group">
							 ...
							 <div class="control-group">
  								...
  								<div class="controls">
  									<input type="text" name="quote" data-required="1" class="span6 m-wrap"/>
  								</div>
  							</div>
  							...
  							<div class="control-group">
								...
								<div class="control-group">
                                          <label class="control-label" for="textarea2">Position </label>
                                          <div class="controls">
                                        <input type="text" name="position" data-required="1" class="span6 m-wrap"/>  </div>
                                        </div>		
