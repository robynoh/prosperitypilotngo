...
if(isset($_GET['news_id'])){
	...
	$resultEdit=ExecuteQuery("select * from interviews  where interview_id='".$_GET['news_id']."'");
...
if(isset($_POST['update'])){
	...
	if(empty($Filename)){
		...
		ExecuteQuery("update interviews set name='".addslashes($_POST['name'])."',content='".addslashes($_POST['content'])."',title='".addslashes($_POST['title'])."',filename='".$rows_Edit['filename']."' where interview_id='".$_GET['news_id']."'");
	...
	$date = date("Y-m-d");
	if(ExecuteQuery("update interviews set name='".addslashes($_POST['name'])."',content='".addslashes($_POST['content'])."',title='".addslashes($_POST['title'])."',filename='".$Filename."' where interview_id='".$_GET['news_id']."'")){
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:14px; color:#000">Interview Edit</b></div>
                            </div>
                            <div class="block-content collapse in">
                              <?php echo $message;?> <div class="span3" style="margin-left:22%; margin-bottom:10px">
                                      <a href="#" class="thumbnail">
                                        <img src="interview_photos/<?php echo $rows_Edit['filename'];?>" width="208" height="183">
                                      </a>
