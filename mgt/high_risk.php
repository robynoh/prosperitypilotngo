...
$news =new news();
	...
	$result  =  ExecuteQuery("SELECT * FROM `high_risk_case`");
                     ...
                     <div class="row-fluid"><?php echo $msg;?>
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left" style="font-weight:bold;color:#000;font-size:14px"> High Risk Cases</div>
                            </div>
                            <div class="block-content collapse in">
								...
								while($rows=SqlArray($result)){?>
                                 ...
                                 <tr class="gradeU">
                                                ...
                                                <td class="center"><?php echo $rows['post_time'];?></td>
                                              </tr>
