...
if($size > 9000000){
	...
	if(ExecuteQuery("insert into projects (project_id,title,content,time_update,day,month,year,filename,status)
	            ...
	            <!-- /wizard -->
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:14px; color:#000">Add Projects</b></div>
                            </div>
					...
					<form action="" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data" method="post">
					  ...
					  <div class="control-group">
  							...
  							<div class="control-group">
                                          <label class="control-label" for="textarea2">Project Detail </label>
                                          <div class="controls">
