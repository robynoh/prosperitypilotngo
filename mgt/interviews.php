...
$news =new news();
	...
	$result  =  ExecuteQuery("SELECT * FROM `interviews`");
                     ...
                     <div class="row-fluid"><?php echo $msg;?>
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left" style="font-weight:bold;color:#000;font-size:14px"> All Interview</div>
                            </div>
                                ...
                                <div class="span12">
                                   <div class="table-toolbar">
                                      <div class="btn-group">
                                       ...
                                       <a href="add_interview"  class="btn " >Add Interview </a><i class="icon-plus icon-white"></i>
                                      </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                 ...
                                 <tr class="gradeU">
                                               ...
                                               <?php echo strip_tags( substr( $rows['content'],0,170)) ;?>...</td>
                                                <td><?php echo $rows['name'];?></td>
												 ...
												 <td class="center"><div class="btn-group"><a class="btn btn-primary"  style="color:#fff" href="edit_interview?news_id=<?php echo ucwords($rows['interview_id']);?>"><i class="icon-pencil icon-white"></i> Edit</a></div></td>
                                              
												
                                                <td class="center"><div class="btn-group"><a href="delete?interview_id=<?php echo $rows['interview_id'];?>" class="btn btn-danger" style="color:#fff"><i class="icon-remove icon-white"></i> Delete</a></button></div></td>
                                            </tr>
