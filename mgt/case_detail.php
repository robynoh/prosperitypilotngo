...
if(isset($_GET['news_id'])){
	...
	$resultEdit=ExecuteQuery("SELECT * FROM `report-case`  WHERE report_id='".$_GET['news_id']."'");
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:14px; color:#000">Case Detail</b></div>
                            </div>
					...
					<form action="" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data" method="post">
						<fieldset>
  							...
  							<div class="control-group">
  								...
  								<div class="controls">
  									<?php echo ucwords($rows_Edit['name']);?>
  								</div>
  							</div>
							<div class="control-group">
  								<label class="control-label"><b>phone</b><span class="required">*</span></label>
  								<div class="controls">
  									<?php echo $rows_Edit['phone'];?>
  								</div>
  							</div>
							<div class="control-group">
  								<label class="control-label"><b>Address where reported case is from</b><span class="required">*</span></label>
  								<div class="controls">
  									<?php echo ucwords($rows_Edit['address']);?>
  								</div>
  							</div>
							<div class="control-group">
  								<label class="control-label"><b>Case</b><span class="required">*</span></label>
  								<div class="controls">
  									<?php echo $rows_Edit['detail'];?>
  								</div>
  							</div>
